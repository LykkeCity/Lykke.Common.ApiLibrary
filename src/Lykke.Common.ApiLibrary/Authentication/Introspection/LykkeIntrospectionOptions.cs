...
namespace Lykke.Common.ApiLibrary.Authentication.Introspection
{
    ...
    /// </summary>
    public class LykkeIntrospectionOptions : AuthenticationSchemeOptions
    {
        /// <summary>
        /// Dafault options constructor
        /// </summary>
        public LykkeIntrospectionOptions()
        {
            Events = new LykkeIntrospectionEvents();
        }
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="LykkeIntrospectionEvents"/> used to handle authentication events.
        /// </summary>
        public new LykkeIntrospectionEvents Events
        {
